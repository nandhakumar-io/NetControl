...
/**
 * Lands here after /api/auth/google/callback redirects back with
 * #token=...&user=... in the URL fragment (never a query string — fragments
 * aren't sent to the server or logged by proxies/access logs).
 */
